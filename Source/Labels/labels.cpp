...
void init_labels() {
	...
	labels[4003] = "Volume";
	labels[4004] = "Mass";
	labels[4005] = "Temperature";
	labels[4006] = "Pressure";
	labels[4007] = "Velocity";
	labels[4008] = "Mass_flow";
	labels[4009] = "Power";
	labels[4010] = "Heat";
	labels[4011] = "Efficiency";
	labels[4012] = "Section";
	labels[4013] = "Angular_Momentum";
	labels[4014] = "Mach";
	labels[4015] = "Heat_Coefficient";
	labels[4016] = "Torque";
	labels[4017] = "Specific_Heats_Ratio";
	labels[4018] = "HRL";
	labels[4019] = "Time";
	labels[4020] = "Cycle";
	labels[4021] = "Work";
	labels[4022] = "Speed";
	labels[4023] = "Fraction";
	labels[4024] = "Corrected_Mass_Flow";
	labels[4025] = "Corrected_Speed";
	labels[4026] = "Pressure_Ratio";
	labels[4027] = "BSR";
	labels[4028] = "Angle";
	labels[4029] = "Mechanical";
	labels[4030] = "Lift";
	...
	labels[3003] = "Pumping";
	labels[3004] = "PMEP";
	labels[3005] = "Combustion";
	labels[3006] = "Liner";
	labels[3007] = "Cylinder_Head";
	labels[3008] = "Piston";
	labels[3009] = "IMEP";
	labels[3010] = "Trapped";
	labels[3011] = "Int";
	...
	labels[3017] = "Intake";
	labels[3018] = "Exhaust";
	labels[3019] = "Short_Circuit";
	labels[3020] = "Average";
	labels[3021] = "Swirl";
	labels[3022] = "Volumetric";
	labels[3023] = "Instantaneous";
	labels[3024] = "Exhaust_Valve";
	labels[3025] = "Intake_Valve";
	labels[3026] = "Total";
	labels[3027] = "Fuel";
	labels[3029] = "Effective";
	labels[3030] = "Left";
	labels[3031] = "Right";
	labels[3032] = "Mechanism";
	labels[3033] = "Mechanical_Losses";
	labels[3034] = "BMEP";
	labels[3035] = "Ambient";
	labels[3036] = "Indicated";
	labels[3037] = "BSFC";
	labels[3038] = "Road_Load";
	labels[3039] = "Vehicle_speed";
	labels[3040] = "Fuel_to_air_ratio";
	labels[3041] = "Gas";
	labels[3042] = "Static";
	labels[3043] = "Wall";
	labels[3044] = "Discharge_Coeff";
	labels[3045] = "Inflow";
	labels[3046] = "Outflow";
	labels[3047] = "Inlet";
	labels[3048] = "Outlet";
	...
	labels[3056] = "D";
	labels[3057] = "Raw";
	labels[3058] = "Filtered";

	labels[5001] = "Cylinder";
	labels[5002] = "Engine";
	labels[5003] = "Plenum";
	labels[5004] = "Pipe";
	labels[5005] = "Node";
	labels[5006] = "Venturi";
	labels[5007] = "Turbocharger";
	labels[5008] = "Compressor";
	labels[5009] = "Turbine";
	labels[5010] = "Root_compressor";
	labels[5011] = "Orifice";
	labels[5012] = "Sensor";
	labels[5013] = "Controller";
	labels[5014] = "WasteGate";
	labels[5015] = "Sheet";
	...
	labels[903] = "(W)";
	labels[904] = "(kg_s)";
	labels[905] = "(kg_s*T^0.5_MPa)";
	labels[906] = "(rpm_K^0.5)";
	labels[907] = "(J)";
	labels[908] = "(bar)";
	labels[909] = "(m_s)";
	labels[910] = "(degC)";
