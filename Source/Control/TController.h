...
public:
	...
	TController(
		nmControlMethod meth,			//!< Type of controller	
		int i							//!< Index
		);
	...
	virtual void AsignaObjetos(
		TSensor **Sensor,				//!< Array with the sensor objects
	...
	virtual void CabeceraResultadosMedControlador(
	...
	virtual void CabeceraResultadosInsControlador(
	...
	virtual void ImprimeResultadosMedControlador(
		std::stringstream& medoutput			//!< StringStream where the average results are stored
		)=0;
	...
	virtual void AcumulaResultadosMediosController(
		double Actual					//!< Current tiem
		)=0;
