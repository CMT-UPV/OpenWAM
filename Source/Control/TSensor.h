...
public:
	...
	void AsignaObjeto(
		TObject *Object					//!< Pointer to the object sensed
		);
	...
	void ActualizaMedida(
		double Time						//!< Current tiem
		);

	/*! Return the type of the object sensed*/
	nmObjectSensed ObjectSensed(){return FObjectSensed;};
	...
	void CabeceraResultadosMedSensor(
		std::stringstream& medoutput			//!< StringStream where the average results are stored
		);

	/*! Generate the header of the instantaneous results*/
	void CabeceraResultadosInsSensor(
		std::stringstream& insoutput			//!< StringStream where the instantaneous results are stored
		);

	/*! Print the average results of the sensor*/
	void ImprimeResultadosMedSensor(
		std::stringstream& medoutput			//!< StringStream where the average results are stored
		);

	/*! Print the instantaneous results of the sensor*/
	void ImprimeResultadosInsSensor(
		std::stringstream& insoutput			//!< StringStream where the instantaneous results are stored
		);
	...
	void AcumulaResultadosMediosSensor(
		double Actual					//!< Current time
		);
