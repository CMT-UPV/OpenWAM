...
TTable::TTable(int i):TController(nmCtlPID,i)
{
...
for(int i=0;i<nvars;i++){
	 fscanf(fich,"%d ",&var);
	 switch(var){
		  case 0: FResMediosCtrl.Output=true; break;
		  case 1: FResMediosCtrl.Error=true; break;
		  case 2: FResMediosCtrl.POutput=true; break;
		  case 3: FResMediosCtrl.IOutput=true; break;
		  case 4: FResMediosCtrl.DOutput=true; break;
		  case 5: FResMediosCtrl.Output_filt=true; break;
		  default : std::cout << "Resultados medios en Controlador " << fID << " no implementados " << std::endl;
	 }
}
...
for(int i=0;i<nvars;i++){
	 fscanf(fich,"%d ",&var);
	 switch(var){
		  case 0: FResInstantCtrl.Output=true; break;
		  case 1: FResInstantCtrl.Error=true; break;
		  case 2: FResInstantCtrl.POutput=true; break;
		  case 3: FResInstantCtrl.IOutput=true; break;
		  case 4: FResInstantCtrl.DOutput=true; break;
		  case 5: FResInstantCtrl.Output_filt=true; break;
		  default : std::cout << "Resultados instantaneos en Controlador " << fID << " no implementados " << std::endl;
	 }
}
