...
public:
	...
	void CabeceraResultadosMedControlador(
		stringstream& medoutput		//!< StringStream where the average results are stored
		);

	/*! Generate the header of the instantaneus results for the controller*/
	void CabeceraResultadosInsControlador(
		stringstream& insoutput 	//!< StringStream where the instantaneous results are stored
		);
	...
	void ImprimeResultadosInsControlador(
		stringstream& insoutput 	//!< StringStream where the average results are stored
		);
	...
	void AcumulaResultadosMediosController(
