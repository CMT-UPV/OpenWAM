...
enum nmRePrmu {
	nmReMassTur = 0, nmReMassCom = 1, nmReMassOil = 2, nmReShaft = 3,
	nmPrTur = 4, nmPrCom = 5, nmPrOil = 6, nmmuG_T = 7, nmmuA_T = 8,
	nmmuO_T = 10, nmmuW_T = 11, nmmuG_H1 = 12, nmmuA_H1 = 13, nmmuO_H1 = 15,
	nmmuW_H1 = 16, nmmuG_H2 = 17, nmmuA_H2 = 18, nmmuO_H2 = 19, nmmuW_H2 = 20,
	nmmuG_H3 = 21, nmmuA_H3 = 22, nmmuO_H3 = 23, nmmuW_H3 = 24, nmmuG_C = 25,
	nmmuA_C = 26, nmmuO_C = 27, nmmuW_C = 28, nmReWater = 29, nmPrWater = 30,
	nmReMassComIn = 31, nmPrComIn = 32, nmReOilH1 = 33, nmReOilH2 = 34,
	nmReOilH3 = 35, nmPrOilH1 = 36, nmPrOilH2 = 37, nmPrOilH3 = 38
...
public:
	...
	void TurbochargerWorkingPoint(double RTC, double MechEff,
		double O_MassFlow, double O_IT, double O_IP, double W_IT,
		double W_MassFlow);
	...
	void SolveNodeTemperatures(double TET, double TSC, double TEC,
		double TOIL, double MassOil, double MechLosses, double TW, double TAMB);
