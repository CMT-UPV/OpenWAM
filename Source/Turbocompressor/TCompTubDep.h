...
void BusquedaEntradaSalida(nmCompressorInlet EntradaCompresor,double AmbientTemperature,
                           int numeroCC,TCondicionContorno **BC,double *AtmosphericComposition);
