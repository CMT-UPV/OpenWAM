...
void TEffCorrector::InputData(double T_AF, double T_Humidity, double T_MassFlow, double T_IT_C,
	double T_IP, double T_PR, double C_Humidity, double C_MassFlow, double C_IT_C, double C_IP,
	double C_PR, double O_MassFlow, double O_IT_C, double O_IP, double RTC) {

	FT.AF = T_AF; // Turbine A/F
	FT.Humidity = T_Humidity; // Turbine Humidity
	FT.MassFlow = T_MassFlow; // Turbine mass flow (kg/s)
	FT.IT_C = T_IT_C; // Turbine Inlet Temperature (ºC)
	...
	FC.IT_C = C_IT_C; // Compressor inlet temperature (ºC)
	...
	FO_IT_C = O_IT_C; // Oil inlet temperature (ºC)
