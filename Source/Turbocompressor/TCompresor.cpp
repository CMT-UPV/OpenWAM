...
TCompresor::TCompresor(int i,nmTipoCalculoEspecies SpeciesModel,int numeroespecies,
...
if(Mapa2T!=NULL) delete Mapa2T;
if(FFraccionMasicaEspecie!=NULL) delete[] FFraccionMasicaEspecie;
}
...
throw Exception("ERROR: InterpolaValoresMapa en el compresor: " +AnsiString(FNumeroCompresor)+N.Message.c_str());
}
}
...
std::cout << "Tipo de error: " << N.Message.c_str() << std::endl;
throw Exception("ERROR: AcumulaMedias en el compresor: " +AnsiString(FNumeroCompresor)+N.Message.c_str());
}
}
...
std::cout << "Tipo de error: " << N.Message.c_str() << std::endl;
throw Exception("ERROR: IniciaMedias en el compresor: " +AnsiString(FNumeroCompresor)+N.Message.c_str());
}
}
...
std::cout << "Tipo de error: " << N.Message.c_str() << std::endl;
throw Exception("ERROR: TCompresor::CalculoPotenciaPaso en el compresor: " +AnsiString(FNumeroCompresor)+N.Message.c_str());
}
}
//---------------------------------------------------------------------------
//---------------------------------------------------------------------------
...
std::cout << "Tipo de error: " << N.Message.c_str() << std::endl;
throw Exception("ERROR: CalculaMedias en el compresor: " +AnsiString(FNumeroCompresor)+N.Message.c_str());
}
}
...
std::cout << "Tipo de error: " << N.Message.c_str() << std::endl;
throw Exception("ERROR: CalculaInstantaneos en el compresor: " +AnsiString(FNumeroCompresor)+N.Message.c_str());
}
}
...
for(int i=0;i<NMagnitudes;i++){
     ...
     switch(Magnitud){
          case 0: FMedias.GraficaTrabajo=true; break;
          case 1: FMedias.GraficaRendimiento=true; break;
          case 2: FMedias.GraficaRelacionCompresion=true; break;
          case 3: FMedias.GraficaGasto=true; break;
          case 4: FMedias.GraficaGastoCorregido=true; break;
          case 5: FMedias.GraficaRegimenCorregido=true; break;
     }
}
...
std::cout << "Tipo de error: " << N.Message.c_str() << std::endl;
throw Exception("ERROR: LeeDatosGraficasMedias en el compresor: " +AnsiString(FNumeroCompresor)+N.Message.c_str());
}
}
...
if(FMedias.GraficaMedias){
	if(FMedias.GraficaTrabajo){
		Label = "\t" + PutLabel(28) + IntToStr(FNumeroCompresor) + PutLabel(907);
		medoutput << Label.c_str();
	}
	if(FMedias.GraficaRendimiento){
		Label = "\t" + PutLabel(22) + IntToStr(FNumeroCompresor) + PutLabel(901);
		medoutput << Label.c_str();
	}
	if(FMedias.GraficaRelacionCompresion){
		Label = "\t" + PutLabel(23) + IntToStr(FNumeroCompresor) + PutLabel(901);
		medoutput << Label.c_str();
	}
	if(FMedias.GraficaGasto){
		Label = "\t" + PutLabel(24) + IntToStr(FNumeroCompresor) + PutLabel(904);
		medoutput << Label.c_str();
	}
	if(FMedias.GraficaGastoCorregido){
		Label = "\t" + PutLabel(25) + IntToStr(FNumeroCompresor) + PutLabel(905);
		medoutput << Label.c_str();
	}
	if(FMedias.GraficaRegimenCorregido){
		Label = "\t" + PutLabel(26) + IntToStr(FNumeroCompresor) + PutLabel(906);
		medoutput << Label.c_str();
	}
}
//fclose(fich);
...
std::cout << "Tipo de error: " << N.Message.c_str() << std::endl;
throw Exception("ERROR: CabeceraGraficasMedias en el compresor: " +AnsiString(FNumeroCompresor)+N.Message.c_str());
}
}
...
//FILE *fich=fopen(FileSALIDA,"a");
if(FMedias.GraficaMedias){
	 if(FMedias.GraficaTrabajo) 			medoutput << "\t" << FMedias.Trabajo;
	 if(FMedias.GraficaRendimiento) 		medoutput << "\t" << FMedias.Rendimiento;
	 if(FMedias.GraficaRelacionCompresion) 	medoutput << "\t" << FMedias.RelacionCompresion;
	 if(FMedias.GraficaGasto) 				medoutput << "\t" << FMedias.Massflow;
	 if(FMedias.GraficaGastoCorregido) 		medoutput << "\t" << FMedias.GastoCorregido;
	 if(FMedias.GraficaRegimenCorregido) 	medoutput << "\t" << FMedias.RegimenCorregido;
}
//fclose(fich);
}
catch(Exception &N)
...
std::cout << "Tipo de error: " << N.Message.c_str() << std::endl;
throw Exception("ERROR: ImprimeGraficasMedias en el compresor: " +AnsiString(FNumeroCompresor)+N.Message.c_str());
}
}
...
for(int i=0;i<NMagnitudes;i++){
     fscanf(fich,"%d",&Magnitud);
     switch(Magnitud){
          case 0: FInstant.GraficaRelacionCompresion=true; break;
          case 1: FInstant.GraficaRendimiento=true; break;
          case 2: FInstant.GraficaPotencia=true; break;
          case 3: FInstant.GraficaGasto=true; break;
          case 4: FInstant.GraficaGastoCorregido=true; break;
          case 5: FInstant.GraficaRegimenCorregido=true; break;
          case 6: FInstant.GraficaGamma=true; break;
     }
}
fgetpos(fich, &filepos);
fclose(fich);
...
if(FInstant.GraficaInstantaneas){
	 if(FInstant.GraficaPotencia){
		Label = "\t" + PutLabel(21) + IntToStr(FNumeroCompresor) + PutLabel(903);
	 ...
	 if(FInstant.GraficaGamma){
		Label = "\t" + PutLabel(27) + IntToStr(FNumeroCompresor) + PutLabel(901);
		insoutput << Label.c_str();
	 }
}
//fclose(fich);
...
std::cout << "Tipo de error: " << N.Message.c_str() << std::endl;
throw Exception("ERROR: CabeceraGraficasInstantaneas en el compresor: " +AnsiString(FNumeroCompresor)+N.Message.c_str());
}
}
...
//FILE *fich=fopen(FileSALIDA,"a");
if(FInstant.GraficaInstantaneas){
	 if(FInstant.GraficaPotencia) 			insoutput << "\t" << FInstant.Potencia;
	 if(FInstant.GraficaRendimiento) 		insoutput << "\t" << FInstant.Rendimiento;
	 if(FInstant.GraficaRelacionCompresion) insoutput << "\t" << FInstant.RelacionCompresion;
	 if(FInstant.GraficaGasto) 				insoutput << "\t" << FInstant.Massflow;
	 if(FInstant.GraficaGastoCorregido) 	insoutput << "\t" << FInstant.GastoCorregido;
	 if(FInstant.GraficaRegimenCorregido) 	insoutput << "\t" << FInstant.RegimenCorregido;
	 if(FInstant.GraficaGamma) 				insoutput << "\t" << FInstant.Gamma;
}
//fclose(fich);
}
catch(Exception &N)
...
std::cout << "Tipo de error: " << N.Message.c_str() << std::endl;
throw Exception("ERROR: ImprimeGraficasInstantaneas en el compresor: " +AnsiString(FNumeroCompresor)+N.Message.c_str());
}
}
