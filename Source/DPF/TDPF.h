...
double getTime1DPF(){return FTime1DPF;};
void putTime1DPF(double valor)
{
FTime1DPF = valor;
};

double getTime0DPF(){return FTime0DPF;};
void putTime0DPF(double valor)
{
   FTime0DPF = valor;
};

double getDeltaTimeDPF(){return FDeltaTimeDPF;};
...
int getNumeroHacesCanales(){return FNumeroHacesCanales;};
double getLongitudEfec(){return FLongitudEfec;};
double getLongitudTapon(){return FLongitudTapon;};
double getEspesorParedPorosa(){return FEspesorParedPorosa;};
...
double getIndCompletitud1(){return FIndiceCompletitud1;};
double getIndCompletitud2(){return FIndiceCompletitud2;};
...
double getCoefAjusTC(){return FCoefAjusTC;};
double getTExt(){return FTExt;};
nmTipoCalcTempParedTubos getTipoCalcTempPared(){return FTipoCalcTempPared;};
nmRefrigerante getTipoRefrig(){return FTipoRefrig;};
double GetDiametroExtHaz(int i){
	return FDiametroHazExt[i];
};
double getCoefExt(){return FCoefExt;};
double GetTSuperficie(int j,int i){
	return FTSuperficie[j][i];
};

int getCicloDPF(){return FCicloDPF;};

double getAjustRAxAnt(){return FAjustRAxAnt;};
double getAjustRAxPos(){return FAjustRAxPos;};
...
double getEspesorAislante(){return FEspesorAislante;};
double getEspesorAire(){return FEspesorAire;};
double getEspesorMetal(){return FEspesorMetal;};
double getConductividadMetal(){return FConductividadMetal;};
double getDiametroEfect(){return FDiametroFiltroEfect;};
