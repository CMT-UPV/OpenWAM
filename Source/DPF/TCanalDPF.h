...
//---------------------------------------------------------------------------
		...
		void Transforma1Area(double v,double a,double p,double **U,double area,double Gamma,
                             double Gamma1,double *Yespecie,int i);

        void Transforma2Area(double *v,double *a,double *p,double **U,double Area,double Gamma,
                             double Gamma1,double *Yespecie,int i);

        void Transforma3Area(double **Ufct,double **U,double Area,double Gamma,double Gamma1,
                             double Gamma6,int i);

		void Transforma4Area(double **U1,double **Ufctd,double Area,double Gamma,double Gamma1,
        ...
        void CalculaFuente2(double **U,double **V2,double *diame,double *CoefTurbulencia,double *hi,
          double *rho,double *TempParedTubo,double *Gamma,double *Rmezcla,double *Gamma1,double *LadoCanal,
          double *VelocidadPared,double *ViscosidadDinamica,double *q_reac1,double *q_reac2,double **FraccionMasicaSalida,
          double *H0Pared,int Nodos,double *EspesorSoot,double *Eficiencia, double *Rreg1,double *Rreg2,
          double *SupEspecifica,double *LongitudVC,double **FraccionMasica);

        void CalculaFuente2Area(double **U,double **V2,double *diame,double *CoefTurbulencia,double *hi,
          double *rho,double *TempParedTubo,double *Gamma,double *Rmezcla,double *Gamma1,double *LadoCanal,
          double *VelocidadPared,double *ViscosidadDinamica,double *q_reac1,double *q_reac2,double **FraccionMasicaSalida,
          double *H0Pared,int Nodos,double *Area,double *EspesorSoot,double *Eficiencia, double *Rreg1,
          double *Rreg2,double *SupEspecifica,double *LongitudVC,double **FraccionMasica);
        ...
        void TransmisionCalor(double tgas,double lado,double *q,double CoefTurbulencia,
             double hi,double rho,double Tw);

        void TransformaContorno(double *L,double *B,double *E,double *a,double *v,
             double *p,int modo,double Gamma1,double Gamma3,double Gamma4,double Gamma5);
...
//---------------------------------------------------------------------------
  ...
  TCanalDPF(int NumeroEspecies,int j,nmTipoCalculoEspecies CalculoEspecies,
				 nmCalculoGamma CalculoGamma,bool HayEGR,TDPF *DPF,int numerocanal,int NumeroDPF);
  ...
  double getNodoIzq(){return FNodoIzq;};
  double getNodoDer(){return FNodoDer;};
  ...
  int getNumeroCanales(){return FNumeroParesdeCanales;};
  ...
  int getNumeroEspecies(){return FNumeroEspecies;};
  double Geth(int i){
	return Fhi[i];
  };
  ...
  int getNodoInicialFuente(){return FNodoInicialFuente;};
  int getNodoFinalFuente(){return FNodoFinalFuente;};
  double getDistanciaInterpolacion(){return FDistanciaInterpolacion;};
