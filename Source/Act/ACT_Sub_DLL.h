...
void CALCULATE_CYCLE(double*roair, double*CAD, double delta_t, double*V_cyl, double VTDC, int counter, double speed,
	double*p_cyl, double*HRF, double*acu_dmf, double*Mbb, double*acu_Mbb, double AFe, double f, double mfuel,
	double mEGR, double mairIVC, double*T_cyl, double HP, double*Yair, double*Yfuel, double*Yburned, double*U,
	double*CV, double*H_cooler, double*H, double TEB, double inj_fuel_temp, double PRECITERACIONES, double*defor,
	double*Rmixture, double Atmosphere_press, double*Gamma, double PI, double Runiv, double Piston_D, double S,
	double Crank_L, double Connecting_Rod_L, double E, double Piston_Axis_D, double Piston_Crown_H, double DBowl,
...
void CALCULUS_OF_IMP_HP(double*complete_p_cyl, double*complete_CAD, double*p_cyl, double*V_cyl, double*complete_V_cyl,
	...
	double M_Connecting_Rod, double M_P_R_PA, double C_ESteel, double C_Mech_Defor, double inlet_pres,
	double exhaust_pres);
