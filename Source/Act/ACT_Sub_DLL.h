...
void CALCULATE_CYCLE(double*roair, double*CAD, double delta_t, double*V_cyl,
	...
	double VBowl, double M_Connecting_Rod, double M_P_R_PA,
	double MW_air, double MW_fuel, double MW_burned, double C_ESteel,
	double C_Mech_Defor, double CTM, double WC1A, double WC1B, double C2,
	double C_MBLBY, double Cbb, double TPIS, double TCYL_HEAD, double TCYL,
	double*Qcylhead, double*Qcyl, double*Qpis);
...
void MASIC_RATIO(double*Yair, double*Yfuel, double*Yburned, double*Rmixture,
	...
	double mfuel, double mEGR, double mairIVC, double Runiv,
...
void ACT(double*engine_parameters,
