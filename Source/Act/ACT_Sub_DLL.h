...
void CALCULUS_OF_VIRTUAL_VELOCITY(double*inj_velocity, double*virtual_velocity,
		double*dmf, double*time_vector,
...
void CALCULUS_OF_REACTION_STOICHIOMETRY(double*O2_mass_fuelunit,
		double*N2_mass_fuelunit, double*CO2_mass_fuelunit,
		double*H2O_mass_fuelunit, double HC);

void STOICHIOMETRY_CONSTANTS(double HC, double*Kst1, double*Kst2, double*Kst3,
		double*Kst4, double*Kst5, double*Kst6);
...
void CALCULATE_CYCLE(double*roair, double*CAD, double delta_t, double*V_cyl,
		...
		double*acu_dmf, double*Mbb, double*acu_Mbb, double AFe, double f,
		double mfuel, double mEGR, double mairIVC, double*T_cyl, double HP,
		double*Yair, double*Yfuel, double*Yburned, double*U, double*CV,
		double*H_cooler, double*H, double TEB, double inj_fuel_temp,
		double PRECITERACIONES, double*defor, double*Rmixture,
		double Atmosphere_press, double*Gamma, double PI, double Runiv,
		double Piston_D, double S, double Crank_L, double Connecting_Rod_L,
		double E, double Piston_Axis_D, double Piston_Crown_H, double DBowl,
		double VBowl, double M_Connecting_Rod, double M_P_R_PA, double MW_air,
		double MW_fuel, double MW_burned, double C_ESteel, double C_Mech_Defor,
		double CTM, double WC1A, double WC1B, double C2, double C_MBLBY,
		double Cbb, double TPIS, double TCYL_HEAD, double TCYL, double*Qcylhead,
...
void CALCULUS_OF_MEAN_VARIABLES(double*p_cyl, double*T_cyl, double*dp_da_cyl,
		double*CAD, double*pmax, double*Tmax, double*dp_da_max, double*p_exit,
		double*T_exit, int size);
...
void CALCULUS_OF_IMP_HP(double*complete_p_cyl, double*complete_CAD,
		...
		int complete_prev_size, double delta_t, double speed, int size,
		double IVC, double EVO, double VTDC, double Cylinder_capacity,
...
void ACT(double*engine_parameters, double*engine_model_constants,
		...
		int size_inlet_inj, int NIN, double*SOI, double*EOI, int CAI,
		double*CAD_exit, double*HRF_exit, double*ROHR_exit, double*p_cyl_exit,
		double*dp_da_cyl_exit, double*T_cyl_exit, double*H_cooler_exit,
		double*mean_var_exit, double*heat_transfer, double*injection_rate_exit,
