...
void TTGV::CalculaTurbina(nmTipoControl TipoControl,double MasaFuel,double Regimen,
                          double PresionAdmision,double RelacionCinematica,double RelExp,
...
if(TipoControl==nmControlPadm){
   ...
   FPosicionTurbina=FPosicionTurbina+FP+FI+FD;   // Posición de la turbina  en % (100% cerrada - 0% abierta)
   ...
   FPosicionTurbina=Interpolacion_bidimensional(Regimen,MasaFuel,FVector_Mf_mapa,
       FVector_Regimen_mapa,FMapa_PosicionTurbina,FNumeroDatos_Regimen,FNumeroDatos_Mf); // en % (100% cerrada - 0% abierta)
}
...
if(x1==0){  // Distancia del vástago 0 mm
 ...
 }else if(x1==1){  // Distancia del vástago 1 mm
...
}else if(x1==2){  // Distancia del vástago 2 mm
...
}else if(x1==3){  // Distancia del vástago 4 mm
...
}else if(x1==4){  // Distancia del vástago 6 mm
...
}else if(x1==5){  // Distancia del vástago 8 mm
...
}else if(x1==6){  // Distancia del vástago 10 mm
...
}else if(x1==7){  // Distancia del vástago 12 mm
