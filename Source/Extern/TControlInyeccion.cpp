...
if(FVector_Mf_mapa!=NULL) delete FVector_Mf_mapa;
if(FVector_Mf_mapaPrail!=NULL) delete FVector_Mf_mapaPrail;
if(FVector_Prail_Regimen_mapa!=NULL) delete FVector_Prail_Regimen_mapa;
if(FVector_Regimen_mapa!=NULL) delete FVector_Regimen_mapa;
...
{
char FileInyeccion[256];
char DatosInyeccion[256];
...
std::cout << "ERROR: Fichero de con datos del inyección no cargado";
}else{
...
// a realizar para realizar el control sobre el sistema de inyección, de acuerdo
// a los requerimientos de ACT. Actualmente ACT necesita como datos para cada ciclo:
// 1.- Número de inyecciones.
...
//     como ángulo de begining el valor 180 y como masa inyectada 0, de acuerdo a lo que
//     el manual de ACT nos indica.

FNumeroInyecciones=2;
MasaFuel=MasaFuel*1e6;   // En los mapas la masa de fuel esta en mg/cc. En ACT también,
                         // luego se pasará el dato ya en estas unidades. 
...
FPrail=Prail*10;   // Presión del common-rail en bar

/* SOI de la inyección principal */
...
FMasaFuel[0]=Interpolacion_bidimensional(Regimen,MasaFuel,FVector_Mf_mapa,
               FVector_Regimen_mapa,FMapa_Combustible_Piloto,FNumeroDatos_Regimen,
               FNumeroDatos_Mf);

/* Masa de fuel inyectada en la principal */
FMasaFuel[1]=MasaFuel-FMasaFuel[0];

FDiferencia_SOI=Interpolacion_bidimensional(Regimen,MasaFuel,FVector_Mf_mapa,
               FVector_Regimen_mapa,FMapa_SOI_Piloto,FNumeroDatos_Regimen,
               FNumeroDatos_Mf);

/* SOI de la inyección piloto */
