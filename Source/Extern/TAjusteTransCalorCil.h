...
double FCaqAdm;
double getCAdmision(){return FCaqAdm;}
void putCAdmision(double valor)
{
FCaqAdm = valor;
};
double FCaqEsc;
double getCEscape(){return FCaqEsc;}
void putCEscape(double valor)
{
FCaqEsc = valor;
};
int FCicloCambioTC;
int getCicloCambioTC(){return FCicloCambioTC;}
void putCicloCambioTC(int valor)
{
FCicloCambioTC = valor;
};
double FCaqAdm2;
double getCAdmision2(){return FCaqAdm2;}
void putCAdmision2(double valor)
{
FCaqAdm2 = valor;
};
double FCaqEsc2;
double getCEscape2(){return FCaqEsc2;}
void putCEscape2(double valor)
{
FCaqEsc2 = valor;
};
int FCicloCambioTC2;
int getCicloCambioTC2(){return FCicloCambioTC2;}
void putCicloCambioTC2(int valor)
{
FCicloCambioTC2 = valor;
};
double FCaqAdm3;
double getCAdmision3(){return FCaqAdm3;}
void putCAdmision3(double valor)
{
FCaqAdm3 = valor;
};
double FCaqEsc3;
double getCEscape3(){return FCaqEsc3;}
void putCEscape3(double valor)
{
FCaqEsc3 = valor;
};
    double getErrorGastoAire(){return FErrorGastoAire;};
