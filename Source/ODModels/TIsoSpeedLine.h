...
public:
	...
	void EffectiveSection(double Area, bool CalculaGR, double Angle, double Diam1, double Diam2,
	...
	double PowerMin(){return FPowerMin;}

	double PowerMax(){return FPowerMax;}
