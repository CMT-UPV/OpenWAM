...
TUnionDireccional::TUnionDireccional(int i, int NUnionDireccional,
		...
		TDepVolCteBase(i, nmUnionDireccional, SpeciesModel, numeroespecies,
...
void TUnionDireccional::LeeDatosUnionDireccional(const char *FileWAM,
	...
	try {
		...
		fscanf(fich, "%d %d %d ", &FNodoEntrada[0], &FNodoEntrada[1],
				&FNodoSalida);
...
void TUnionDireccional::LeeDatosUnionDireccionalXML(xml_node node_junction) {
	try {
		...
		FNodoEntrada[0] = GetAttributeAsInt(node_junction, "Input1");
		FNodoEntrada[1] = GetAttributeAsInt(node_junction, "Input2");
		FNodoSalida = GetAttributeAsInt(node_junction, "Output");
		FCDSalidaInicial[0] = GetAttributeAsDouble(node_junction, "DCOutIni1");
		FVelocidadCorte[0] = GetXMLSpeed(node_junction, "MinVelocity1");
		FVelocidadFin[0] = GetXMLSpeed(node_junction, "MaxVelocity1");
		FCDSalidaInicial[1] = GetAttributeAsDouble(node_junction, "DCOutIni2");
		FVelocidadCorte[1] = GetXMLSpeed(node_junction, "MinVelocity2");
		FVelocidadFin[1] = GetXMLSpeed(node_junction, "MaxVelocity2");
