...
struct stCompSolverA2{
	...
	stCompSolverA2(double c2,double g,double RC,double cp0,double aa1,double aa2,double a1,double s1,double s2,double v1)
...
struct stCompSolverA1{
	...
	stCompSolverA1(double c1,double c2,double s1,double s2,double g,double aa1,double aa2,
		double RC,double Rd,double Lc,double cp0,double inct)
		: CC1(c1), CC2(c2), AA1ini(aa1), AA2ini(aa2), Sec1(s1), Sec2(s2), RelComp(RC),
		Gam(g), Rend(Rd), Dt(inct), CPAnt(cp0), LCar(Lc){
