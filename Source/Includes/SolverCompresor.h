...
struct stCompSolverVIn{
	...
	stCompSolverVIn(Doub cari,Doub caro,Doub aai,Doub g,Doub rm,Doub cpm,Doub sin,Doub sout,Doub rc,Doub cpre,Int_ s,Int_ sf,Doub ttinant,
		Doub ttoutant,Bool dir,Bool firt)
	{
		CarIn=cari;
		CarOut=caro;
		AaIn=aai;
...
//		AIn=ARef*CarIn-(double)Sig*0.5*Gam1*VIn;
