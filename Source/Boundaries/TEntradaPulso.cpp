...
TEntradaPulso::~TEntradaPulso()
{
if(FTiempo!=NULL) delete FTiempo;
if(FPresionRelativa!=NULL) delete FPresionRelativa;
if(FNivelEntropia!=NULL) delete FNivelEntropia;
...
throw Exception(("ERROR: TEntradaPulso::LeeEntradaPulso " +N.Message).c_str());
}
}
...
std::cout << "Tipo de error: " << N.Message.c_str() << std::endl;
throw Exception(("ERROR: TEntradaPulso::BusquedaInstante " +N.Message).c_str());
}
}
...
std::cout << "Tipo de error: " << N.Message.c_str() << std::endl;
throw Exception(("ERROR: TEntradaPulso::InterpolaPresion " +N.Message).c_str());
}
}
...
std::cout << "Tipo de error: " << N.Message.c_str() << std::endl;
throw Exception(("ERROR: TEntradaPulso::InterpolaEntropia " +N.Message).c_str());
}
}
