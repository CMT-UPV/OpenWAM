...
TCCExtremoAnecoico::TCCExtremoAnecoico(nmTypeBC TipoCC,int numCC,
...
{
std::cout << "ERROR: TCCExtremoAnecoico::AsignaTubos en la condición de contorno: " << FNumeroCC <<  std::endl;
...
{
std::cout << "ERROR: TCCExtremoAnecoico::CalculaCondicionesContorno en la condición de contorno: " << FNumeroCC << std::endl;
std::cout << "Tipo de error: " << N.Message.c_str() << std::endl;
throw Exception(N.Message.c_str());
}
}
