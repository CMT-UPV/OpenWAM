...
void TCCExternalConnectionVol::UpdateCurrentExternalProperties(double U0, double T0, double P0,
	double t) {
...
void TCCExternalConnectionVol::ReadBoundaryData(const char *FileWAM, fpos_t &filepos, int NumberOfPipes,
