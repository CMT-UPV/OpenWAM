...
double FConductividad;
  ...
  void Estrechamiento(double CCS,double CCE,double rel_entropia,double rel_area,
  double smag,double *xa1,double *xa2,double *xu2,double *xu1);

  void Ensanchamiento(double CCS,double CCE,double rel_entropia,double rel_area,
  double smag,double *xu1,double *xu2,double *xa2,double *xa1,double *xx3);


public:

    double getEspesor(){return FEspesor;};
    double getConductividad(){return FConductividad;};

  TCCUnionEntreTubos(nmTypeBC TipoCC,int numCC,nmTipoCalculoEspecies SpeciesModel,
