...
if(FFuerza!=NULL) delete[] FFuerza;
if(FLev1!=NULL) delete[] FLev1;
if(FLev2!=NULL) delete[] FLev2;
if(FLev3!=NULL) delete[] FLev3;
}
...
switch(tipo){
     case 0: FTipoLamina=nmLamina0D; break;
     case 1: FTipoLamina=nmLamina1D; break;
     case 3: FTipoLamina=nmLamina2D; break;
     default: std::cout << "ERROR: Seleccion Tipo de Lamina" << std::endl; break;
}
switch(sentido){
     case 0: FSentidoLamina=1; break;
     case 1: FSentidoLamina=-1; break;
     default: std::cout << "ERROR: Seleccion Sentido de Lamina" << std::endl; break;
}
...
switch(FTipoLamina){
	 ...
	 case nmLamina2D:
          ...
          for(int veces=0;veces<=FBucle;++veces){
               ...
               if(FLev3[FNodosLamina+FNodosFijos+1]<0.) FLev3[FNodosLamina+FNodosFijos+1]=0;
