...
switch(Ctrl){
     case 0: FTipoContr=nmContrAngulo; break;
     case 1: FTipoContr=nmContrFuel; break;
}
...
if(FTipoContr==nmContrAngulo) xx=AnguloActual;
else if(FTipoContr==nmContrFuel) xx=Mf;
else{
